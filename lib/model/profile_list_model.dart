...
//
//     final ProfileListModel = ProfileListModelFromJson(jsonString);

// ignore_for_file: file_names

import 'dart:convert';

ProfileListModel profileListModelFromJson(String str) =>
    ProfileListModel.fromJson(json.decode(str));

String profileListModelToJson(ProfileListModel data) =>
...
class BasicPartnerInfo {
  ...
  String? partnerJobDetails;
  List<dynamic>? partnerJobCountry;
  String? partnerJobState;
  String? partnerJobCity;
...
class Complex {
  ...
  factory Complex.fromJson(Map<String, dynamic> json) => Complex(
        id: json["id"],
        complexionName: json["complexion_name"],
  ...
  Map<String, dynamic> toJson() => {
        "id": id,
        "complexion_name": complexionName,
...
class UserFamilyInfo {
  UserFamilyInfo({
    ...
    this.userSiblingDetails,
    this.paternalUncleAddress,
    required this.createdAt,
    required this.updatedAt,
  });
