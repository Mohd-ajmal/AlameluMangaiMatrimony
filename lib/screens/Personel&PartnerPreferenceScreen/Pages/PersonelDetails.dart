...
import 'package:matrimony/screens/Personel&PartnerPreferenceScreen/Pages/EditPages/MyInfoEditPage.dart';
...
class PersonelDetails extends StatefulWidget {
  String? appbar;
  PersonelDetails({Key? key, required this.appbar}) : super(key: key);
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    details(
                        ...
                        name2: 'Complexion',
                        value2:
                            complexion.isEmpty ? 'Not specified' : complexion),
                    const SizedBox(
                      height: 10.0,
                    ),
                    details(
                    ...
                    Container(
                      ...
                      child: Text(
                          eatingHabit.isEmpty ? 'Not specified' : eatingHabit),
                    ),
                    const SizedBox(
                      height: 10.0,
                    ),
                    ...
                    Container(
                      ...
                      child: Text(
                          _userAdress.isEmpty ? "Not specified" : _userAdress),
                    ),
                    const SizedBox(
                      height: 10.0,
                    ),
                    ...
                    Container(
                      ...
                      child: Text(
                          _bloodGroup.isEmpty ? "Not specified" : _bloodGroup),
                    ),
                    const SizedBox(
                      height: 10.0,
                    ),
                    ...
                    ElevatedButton(
                      onPressed: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => MyInfoEditPage(
                                      basicInfoUser: _basicInfoUser,
                                    )));
                      },
