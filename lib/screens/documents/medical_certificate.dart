...
class _MedicalCertificateState extends State<MedicalCertificate> {
  ...
  Widget buildGridView() {
    if (imageUpload != null) {
      ...
      return const Center(
          child: Text('Select image to upload medical certificate'));
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Upload medical certificate",
  ...
  upload(File imageFile, {required context}) async {
    try {
      ...
      // string to uri
      var uri = Uri.parse(
          "https://alamelumangaimatrimony.com/api/v1/user-profile/user-medical-certificate-upload/$userId");
      ...
      var multipartFile = http.MultipartFile(
          'medical_certificate', stream, length,
